...
SystemJS.config({
  ...
  map: {
    ...
    'dtrace-provider': 'npm:dtrace-provider@0.8.3',
    'events': 'github:jspm/nodelibs-events@0.2.2',
    'fs': 'github:jspm/nodelibs-fs@0.2.0-alpha',
    'gelf-stream': 'npm:gelf-stream@1.1.1',
    ...
    'safe-json-stringify': 'npm:safe-json-stringify@1.0.4',
  ...
  packages: {
    ...
    'npm:gelf-stream@1.1.1': {
      'map': {
        'gelfling': 'npm:gelfling@0.3.1'
      }
    }
  }
});
